...
Therefore, `mean(is.na(x))` calculates the mean of a logical vector, where `TRUE` is equal to `, and `FALSE` is equal to 0.

This function calculates the proportion of missing values in an object.
