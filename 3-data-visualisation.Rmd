...
Points may be overlapping each other (this is known as overplotting). To improve this plot, you could some random noise to the points by using `position = jitter` or, its useful shortcut, `geom_jitter()`.
